...
public class MapCurrentActivity extends AppCompatActivity {
    ...
    private static final String TAG = "MapCurrentActivity";
    private  String cur="";
    //全局Application
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.back:
                ...
                break;
            case R.id.btn_sure:
                Currentaddress currentaddress=new Currentaddress(cur);
                EventBus.getDefault().postSticky(currentaddress);
                MapCurrentActivity.this.finish();
