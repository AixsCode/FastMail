...
public class MapReceiveActivity extends AppCompatActivity {
    ...
    private static final LatLng mLoactionLatLng = new LatLng(31.501899, 120.376754);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.back:
                ...
                break;
            case R.id.btn_sure:
                Receiveaddress receiveaddress=new Receiveaddress(rec_address);
                EventBus.getDefault().postSticky(receiveaddress);
                MapReceiveActivity.this.finish();
                break;
        }
    }
