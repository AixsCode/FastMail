...
import com.wxs.fastmail.behavior.CtrlLinearLayoutManager;
import com.wxs.fastmail.behavior.MarginConfig;
import com.wxs.fastmail.behavior.ZoomHeaderView;
...
public class BusinessActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView.setAdapter(new com.wxs.fastmail.adapter.ListAdapter());
    ...
    class Adapter extends PagerAdapter
    {
        public Adapter() {
            views = new ArrayList<>();
            views.add(View.inflate(BusinessActivity.this, R.layout.business_item_img, null));
            views.get(0).findViewById(R.id.btn_buy).setOnClickListener(new View.OnClickListener() {
                @Override public void onClick(View v)
                {
                    Intent intent=new Intent(BusinessActivity.this,BusinessOrderActivity.class);
        ...
        private int[] imgs = { R.drawable.business_pic6, R.drawable.business_pic2, R.drawable.business_pic3 };
