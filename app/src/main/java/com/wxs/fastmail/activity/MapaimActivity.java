...
public class MapaimActivity extends AppCompatActivity {
    @Bind(R.id.back)
    ImageView back;
    @Bind(R.id.btn_sure)
    TextView btnSure;
    ...
    private static final String TAG = "MapaimActivity";
    private  String aim="";
    //全局Application
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mapaim);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.back:
                MapaimActivity.this.finish();
                break;
            case R.id.btn_sure:
                Aimaddress aimaddress=new Aimaddress(aim);
                EventBus.getDefault().postSticky(aimaddress);
                MapaimActivity.this.finish();
                break;
        }
    }
