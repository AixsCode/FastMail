...
public class Util_HiddenAnim {
     ...
     */
    public static Util_HiddenAnim newInstance(Context context, View hideView, View down, int height){
        return new Util_HiddenAnim(context,hideView,down,height);
    }

    private Util_HiddenAnim(Context context,View hideView,View down,int height) {
